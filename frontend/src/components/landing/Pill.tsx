  ...
  return (
    ...
    >
      <span
        ...
        className="absolute inline-block w-[var(--h)] top-[var(--hh)] left-[var(--hh)] h-[2px] -rotate-45 origin-top -translate-x-1/2 bg-[color:var(--landing-border)]"
      />
      <span
        style={{ "--h": px(hypotenuse), "--hh": px(hypotenuseHalf) } as React.CSSProperties}
        className="absolute w-[var(--h)] top-[var(--hh)] right-[var(--hh)] h-[2px] bg-[color:var(--landing-border)] rotate-45 translate-x-1/2"
      />
      <span
        style={{ "--h": px(hypotenuse), "--hh": px(hypotenuseHalf) } as React.CSSProperties}
        className="absolute w-[var(--h)] bottom-[var(--hh)] left-[var(--hh)] h-[2px] bg-[color:var(--landing-border)] rotate-45 -translate-x-1/2"
      />
      <span
        style={{ "--h": px(hypotenuse), "--hh": px(hypotenuseHalf) } as React.CSSProperties}
        className="absolute w-[var(--h)] bottom-[var(--hh)] right-[var(--hh)] h-[2px] bg-[color:var(--landing-border)] -rotate-45 translate-x-1/2"
      />

      <span className="inline-block size-2.5 rounded-full bg-[color:var(--landing-primary)] mr-2 shadow-[0_0_8px_2px_var(--landing-primary)]" />
