...
| Core build | Sat Aug 1 to Sun Aug 2 (Building Ends) | Reputation stamp, live event feed, bounty list, progress tracker + explorer links, refund UI, demo GIF | `hackathon-build` | you |
